...
description: Audit an AI-assisted research output for evidence, citation fit, source coverage, calculations, reproducibility, disclosure, privacy, and human review. Use when a research librarian or workshop participant asks to inspect a research report, search plan, citation list, evidence matrix, spreadsheet analysis, synthesis, methods note, or patron handoff before it is shared or used.
---
